...
/// Everything the Admin Panel needs: a PIN gate and ZIP-package import.
///
...
class AdminService {
  ...
  /// Demo-only gate. This is not real authentication — it exists so
  /// the Admin Panel isn't one tap away from the main navigation, not
  /// to protect anything sensitive. A real deployment would replace
  /// this with actual account-based auth.
  static const String demoPin = '1234';

  static bool checkPin(String input) => input == demoPin;
